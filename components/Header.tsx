    ...
    return (
        <header className="sticky top-0 z-30 flex w-full items-center justify-between bg-[#F6F4EE] p-4">
            ...
            <div className='hidden flex-1 items-center justify-center font-bold text-lg  space-x-8 md:flex'>
                <a href='https://www.kaam24x7.com/#services' className='headerLink'>Categories</a>
            ...
            <div className='flex items-center justify-center gap-x-4 md:w-1/5'>
                ...
                <Link href='/checkout'>
                    <div className='relative cursor-pointer'>
                        <span className='absolute -right-1 -top-1 text-white  z-50 flex h-4 w-4 items-center justify-center rounded-full bg-gradient-to-r from-[#5E474C] to-[#5E474C] font-bold text-[10px]'></span>
